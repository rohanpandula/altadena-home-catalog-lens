...
*/
/*
@typedef MorphShapeSettings
@property {vec2} shapeScale = {1,1}
@property {vec2} shapePosition = {0,0}
@ui {"widget":"label", "label":""}
...
@ui {"widget":"label", "label":""}
@ui {"widget":"separator"}
@ui {"widget":"label", "label":"<em>Morph Child Offsets</em>"}
@property {vec2} childScale = {1,1}
@property {vec2} childOffset = {0,0}
@property {vec4} childRadius = {0.25,0.25,0.25,0.25} {"widget":"slider", "min":0, "max":1, "step":0.01}
*/
/*
...
// @ui {"widget":"separator"}
// @input MorphShapeSettings shapeSettings
// @ui {"widget":"separator"}
// @ui {"widget":"group_start", "label":"Icon Setup"}
// @input Asset.Texture icon0 {"label":"Icon Set"}
// @input Asset.Texture icon1 {"label":"Child Icon Set"}
...
var Module = require("../../../../../Modules/Src/Assets/Liquid Glass UI Pack.lspkg/Liqmo Morph Button.lsc/Liqmo Morph Button");
Object.setPrototypeOf(script, Module.LiqmoMorphButton.prototype);
script.__initialize();
